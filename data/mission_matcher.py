...
class Signal:
    """Un signal FEC tel que défini dans referentiel_signaux_fec.json."""
    ...
    def from_dict(cls, d: dict) -> "Signal":
        return cls(
            ...
            regle_calcul=d["regle_calcul"],
            seuil=d["seuil"],
            periode_reference=d["periode_reference"],
        )
...
class MissionMatcher:
    ...
    def from_files(
        ...
        signaux = {s["code"]: Signal.from_dict(s) for s in signaux_raw}
...
if __name__ == "__main__":
    ...
    matcher = MissionMatcher.from_files(
        base / "catalogue_missions_tyls.json",
        base / "referentiel_signaux_fec.json",
    )
